...
static const long kUploadTitleFieldTag = 1;
static const long kUploadTextViewTag = 2;
...
- (void)addShareDialogWithTitle: (NSString*) shareTitle
{
    ...
    titleField.tag = kUploadTitleFieldTag;
    ...
    textView.tag = kUploadTextViewTag;
    ...
    self.containerView = demoView;
}

- (NSString*) getShareTitle{
    return [(UITextField*) [self.containerView viewWithTag:kUploadTitleFieldTag] text];
}
- (NSString*) getDescriptionTitle{
    return [(UITextView*) [self.containerView viewWithTag:kUploadTextViewTag] text];
}
